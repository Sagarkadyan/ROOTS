    ...
    <GlassCard className="h-full flex flex-col justify-between">
      <div>
        ...
        <div className="flex flex-col items-center mt-6">
          <ProgressRing percentage={0} size={160} strokeWidth={10} color="var(--accent-green)" />
          <h3 className="font-display font-bold text-xl mt-6">Today&apos;s Goal: 45 min</h3>
          <div className="flex flex-col items-center mt-2 space-y-1">
            <span className="text-[var(--accent-green)] font-medium">0 min studied</span>
            <span className="text-[var(--text-muted)] text-sm">45 min remaining</span>
          </div>
        </div>
      </div>
